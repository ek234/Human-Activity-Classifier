...
def create_model (X_train, X_val, X_test, y_train, y_val, y_test, c, isred):
    print("hiii")
    start_time = time()
...
if __name__ == "__main__":
    ...
    print(f"C: {C}, using reduced set: {use_reduced}")
    ...
    train_time, acc_v, acc_t = create_model(X_train, X_val, X_test, y_train, y_val, y_test, C, use_reduced)
